      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8">
            How You Can Help Us Share
          </h2>
          <p className="text-lg text-center text-gray-700 mb-12">
            Every share, every mention, and every conversation helps us extend
            our reach and gather more support for our beneficiaries. Here are
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Share our posts, stories, and campaigns on your social media
                channels.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
