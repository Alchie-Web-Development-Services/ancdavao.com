      ...
      >
        ...
        <div className="relative container mx-auto text-center z-10">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Through the love of Christ and the strength of our community, we
            fight hunger and uplift lives. Join us in building a future where no
            child in Davao City goes to bed hungry.
          </p>
