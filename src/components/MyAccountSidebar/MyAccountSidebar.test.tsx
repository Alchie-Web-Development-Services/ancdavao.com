...
describe("MyAccountSidebar", () => {
  it("renders the sidebar with user info and navigation links", () => {
    render(<MyAccountSidebar fullName="John Doe" email="john.doe@example.com" />);
    ...
    expect(screen.getByRole("link", { name: "Donation History" })).toBeInTheDocument();
    expect(screen.getByRole("link", { name: "Sponsorships" })).toBeInTheDocument();
  });
});
